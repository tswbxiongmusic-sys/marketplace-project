...
def seller_sales_stats(seller):
    ...
    totals = paid_items.aggregate(revenue=Sum("total_price"), units_sold=Sum("quantity"))
    order_count = paid_items.values("order_id").distinct().count()
